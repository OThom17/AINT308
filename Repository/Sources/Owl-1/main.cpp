 ...
 */
    ...
    while (inLOOP){
        ...
        while (inLOOP){
            ...
            switch (key){
            case 38://2490368: Changed BILL//up arrow
                Ry=Ry+5;Ly=Ly-5; // was Ly=+5 Changed BILL
                break;
            case 40://2621440: Changed BILL//down arrow
                Ry=Ry-5;Ly=Ly+5; // was Ly=-5 BILL
                break;
            case 37://2424832: Changed BILL//left arrow
                Rx=Rx-5;Lx=Lx-5;
                break;
            case 39://2555904: Changed BILL// right arrow
                Rx=Rx+5;Lx=Lx+5;
                break;
            case 99: // lowercase 'c'
